            ...
            cl_context *context, cl_program *program)
{
    ...
    status = clEnqueueWriteBuffer(imgqueue, d_inputImage, CL_TRUE, 0, sizeof(float) * imageSize, inputImage, 0, NULL, NULL);
    status = clEnqueueWriteBuffer(imgqueue, d_filter, CL_TRUE, 0, sizeof(float) * filterSize, filter, 0, NULL, NULL);
    ...
    clEnqueueNDRangeKernel(imgqueue, kernel, 2, 0, globalws, localws, 0, NULL, NULL);
